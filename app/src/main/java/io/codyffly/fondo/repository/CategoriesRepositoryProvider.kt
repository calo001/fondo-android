...
object CategoriesRepositoryProvider {
    fun provideCategoriesRepository() : List<Category> {
        return listOf(
            ...
            Category(R.drawable.fodd_drink, R.string.food_drink, R.drawable.back_food_drink),
            ...
            Category(R.drawable.business_work,R.string.business_work, R.drawable.back_business_work),
            Category(R.drawable.fashion, R.string.fashion, R.drawable.back_fashion),
            Category(R.drawable.art_culture, R.string.art_culture, R.drawable.back_arts_culture),
            Category(R.drawable.architecture, R.string.architecture, R.drawable.back_architecture),
            Category(R.drawable.texture_pattern, R.string.texture_pattern, R.drawable.back_texture_pattern),
            Category(R.drawable.technology, R.string.technology, R.drawable.back_technology),
